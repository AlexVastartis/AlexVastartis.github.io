...
export const GROUPING_BLURB: Record<string, string> = {
  'Blue Bloods':
    'The programs the rating sets clearly apart at the top, and by a clear margin. Every one has been nationally relevant across multiple eras. None is in real decline.',
  'Blue Blood Fringe':
    'The perennial “is it a blue blood?” teams — résumés deep enough to argue for the top, recent decades that argue against it. In every era’s conversation, in no era’s inner circle.',
  'Blue Blood Contenders':
    'The programs with a real, current case for the top — a title era in living memory and a rating closing on the fringe. What separates them from blue-blood status is decades of it, not one more good year.',
  'National Powers':
