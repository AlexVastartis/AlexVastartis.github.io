...
export const MAP_BLURB: Record<string, string> = {
  ...
  'the vacated wins toggle': 'NCAA official (default) vs. as played — drops or re-adds NCAA-vacated wins.',
  ...
  'the trajectory arrow': '▲ Ascending / ▼ Descending / – Maintaining, versus the program’s own history. A doubled, stacked arrow marks an emphatic move — a last-decade rating a whole class from the all-time one. A dash also means too few seasons on record to judge.',
  'the ranking row subline': 'The muted line under the team name — the trajectory, described.',
  ...
  // ---- the team panel ----
  'the team panel': 'The tall highlighted-team card — sticky right rail on list views.',
  'the team strip': 'The compact highlighted-team bar — on chart views and above the what-if editor.',
  ...
  'the stat breakdown': 'The ten rating stats — full size in the panel (criterion-grouped, value + percentile), slim in the strip (five paired lines). Outliers greyed & struck.',
  ...
  'the path-forward blurb': 'Path Forward — what it would take, in modern-season terms, to reach that tier; for the top six, what it takes to hold the line.',
  ...
  'the what-if button': 'The dashed amber ⚡ button under Path Forward — opens the what-if editor on this program.',
  ...
  'the sortable headers': 'Program / stat / stat / Pctl — click to sort, click again to flip.',
  ...
  'the chart action bar': 'Top-right of the chart frame — the marker toggle and the PNG button.',
