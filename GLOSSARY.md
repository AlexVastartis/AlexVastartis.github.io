...
| **Range brace** | pen-in-the-margin annotation beside the **Blue Bloods** and **Blue Blood Contenders** groupings only — a hand-drawn curly brace spanning the section, labelled with the rating spread (top team minus base team, e.g. `2.8% range`). Wide-desktop margin only; collapses to a small note in the grouping header on narrower screens |
